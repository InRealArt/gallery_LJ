import NewsletterSectionAnimated from "./NewsletterSectionAnimated";

export default function NewsletterSection() {
  return (
    <section className="py-32 bg-[#111] text-white text-center px-10">
      <NewsletterSectionAnimated>
        <div className="newsletter-content flex flex-col items-center">
          ...
          <form className="max-w-xl w-full flex flex-col md:flex-row gap-6">
            <input
              type="email"
